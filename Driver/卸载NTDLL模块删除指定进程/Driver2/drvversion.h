...
#define DRV_YEAR               2014 // current year or timespan (e.g. 2003-2009)
...
#define TEXT_MODULE            Driver2 // module name
...
#define TEXT_INTERNALNAME      Driver2.sys // copyright information
