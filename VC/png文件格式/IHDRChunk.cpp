...
int CIHDRChunk::GetWidth()
{
	return GetBufferintoDWORDWithNetworkOrder(m_szBuffer);
}

int CIHDRChunk::GetHeight()
{
	return GetBufferintoDWORDWithNetworkOrder(m_szBuffer+4);
}

int CIHDRChunk::GetColorDepth()
{
	return (int) m_szBuffer[8];
}

void CIHDRChunk::SetColorDepth(int nDep)
{
	m_szBuffer[8] = nDep;
}
