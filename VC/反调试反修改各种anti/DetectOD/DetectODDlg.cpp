...
ON_BN_CLICKED(IDC_BUTTON1, OnHeapDetect)
//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
{
	// TODO: Add your control notification handler code here
	//::ShellExecute(NULL,"open","http://hi.baidu.com/tjt999",NULL,NULL,SW_SHOWNORMAL);
}
...
BOOL HeapDetect()
{
	LPVOID HeapPtr = HeapAlloc(GetProcessHeap(),NULL,0x100);
	PDWORD HeapAddr = (PDWORD)HeapPtr;
	ULONG magic = 0;
	...
	{
		return ((magic>10)?TRUE:FALSE);
	}
}
void CDetectODDlg::OnHeapDetect() 
{
	// TODO: Add your control notification handler code here
	if (HeapDetect())
	{
