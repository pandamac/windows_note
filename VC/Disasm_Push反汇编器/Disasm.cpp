...
I have not used big table - time prob -, although it is highly recomended! (hopefully in future)
	*/
    ...
    PrefixesSize = RegPrefix + LockPrefix + SegPrefix + AddrPrefix; 
	// No RepPrefix
    PrefixesRSize = PrefixesSize + RepPrefix; 
	// Special Case (Rep Prefix is being used -> String menemonics only)
